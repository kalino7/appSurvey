<?php
  ...
  if( isset($_GET['keys']))
  {
    ...
    $query = $db->query("SELECT * FROM activate WHERE activeKey = '$key' ");
    ...
    if($query->num_rows > 0)
    {
      ...
      {
        $flag = '
        <h1>ERROR <span class="counter"> 304</span></h1>
        <p>Sorry, Your Account Could Not Be Activated. Do Contact The Support Team For Help. </p>
    ...
    else
    {
      ...
      <p>Sorry, Broken Link. It is Either Your Account Has Already Been Activated OR The Activation Link Is Faulty. </p>
      <p>If The Later Is The Case, Then You Need To Check The Link That Was Sent To Your Mail. </p>
      <a href="#" class="btn btn-lg btn-default">Support Team</a>
      ';
    }
  }
  else
  {
    ...
    <p>Sorry, Invalid Activation Link. </p>
    ';
  }
...
<head>
    ...
    <title>Welcome Page | <?php echo $theme;?></title>
